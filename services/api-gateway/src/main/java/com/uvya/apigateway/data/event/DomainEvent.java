...
public record DomainEvent(UUID eventId, String eventType, int eventVersion, Instant occurredAt,
        String traceId, String correlationId, String idempotencyKey, JsonNode payload) {
    public DomainEvent(UUID eventId, String eventType, int eventVersion, Instant occurredAt,
            String traceId, String idempotencyKey, JsonNode payload) {
        this(eventId, eventType, eventVersion, occurredAt, traceId, traceId, idempotencyKey, payload);
    }
