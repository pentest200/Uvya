...
The application containers currently expose only lifecycle endpoints. They do not write messages, authenticate users, or consume external dependencies yet.
